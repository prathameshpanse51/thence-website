...
export default function Footer() {
  return (
    <>
      <footer className="w-[95%] md:w-[98%] h-[100%] flex flex-col md:flex-row items-center gap-10 md:gap-0 justify-between p-[30px] md:p-[60px] mx-auto my-8 bg-[#F5F5F5] rounded-[40px]">
