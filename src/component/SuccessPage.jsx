  ...
  return (
    <>
        ...
        >
          <Toolbar>
            <Typography
              variant="h6"
              component="div"
              sx={{ flexGrow: 1, transform: "scale(0.8)" }}
            >
              <svg
                width="121"
                height="32"
      ...
      <main className="md:w-[718px] flex flex-col mx-10 md:mx-auto content-center items-center mt-10 md:mt-0 gap-[20px] md:gap-[41px]">
        ...
        <div className="flex flex-col items-center gap-[10px] md:gap-[16px] tracking-tighter">
          <h2 className="covered-by-your-grace-regular text-2xl md:text-4xl text-[#2DA950]">
            Success Submitted{" "}
          </h2>
          <div className="flex flex-col items-center gap-[20px]">
            <h1 className="manrope600 text-3xl md:text-6xl text-[#1C1C1C]">
              Congratulations
            </h1>
            <p className="manrope500 text-sm md:text-2xl text-[#727272] text-center">
