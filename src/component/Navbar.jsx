        ...
        >
          <Toolbar>
            ...
            <Box className="flex gap-4">
              <button className="manrope500 w-[189.56px] h-[77.22px] border-[1.31px] border-[#EAEAEA] rounded-[107.06px] p-[26.11px, 41.78px, 26.11px, 41.78px] text-[#1C1C1C] text-lg leading-6 hover:bg-[#F1F1F1] hover:transition-all hover:duration-800">
                Get Projects
              </button>
