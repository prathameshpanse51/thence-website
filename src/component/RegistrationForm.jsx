...
export default function RegistrationForm() {
  ...
  return (
    <>
          ...
          <Toolbar>
            ...
            <Box>
              <button
                ...
                className="manrope500 w-[64px] h-[64px] border-[1.31px] border-[#CACACA] rounded-[107.06px] text-[#1C1C1C] hover:bg-[#F1F1F1] hover:transition-all hover:duration-800"
              >
      ...
      <main className="flex flex-col items-center gap-[52px] mb-20">
        <div className="flex flex-col gap-[16px] items-center">
          <h2 className="covered-by-your-grace-regular text-4xl text-[#2DA950] tracking-tighter">
            Registration Form
          </h2>
          <h1 className="manrope600 text-6xl text-[#1C1C1C] leading-[67px]">
            Start your success <br /> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;Journey
            here!
          </h1>
        </div>
